...
master_wb = intialize_master(master_loc="/Users/lucasg17/Documents/GitHub/Health-Innovation/Master.xlsx", name=search_name)
...
while row<=num_entries:
    ...
    if 'A' not in doc_type: #if not an amendment
        ...
        add_data(master_book=master_wb, newdata_loc="/Users/lucasg17/Downloads/convertcsv.xlsx", name=search_name, file_year=year)
        ...
        driver.switch_to.window(driver.window_handles[0])
        add_data(master_book=master_wb, newdata_loc="/Users/lucasg17/Downloads/convertcsv (1).xlsx", name=search_name, file_year=year_2) #put the full amendment first to handle the correct headers
        add_data(master_book=master_wb, newdata_loc="/Users/lucasg17/Downloads/convertcsv.xlsx", name=search_name, file_year=year_1)
        ...
        if check_amendment(newdata_loc_1="/Users/lucasg17/Downloads/convertcsv.xlsx", newdata_loc_2="/Users/lucasg17/Downloads/convertcsv (1).xlsx"): #checks which kind of amendment - True=overwritten, False=addition
            add_data(master_book=master_wb, newdata_loc="/Users/lucasg17/Downloads/convertcsv.xlsx", name=search_name, file_year=year_1) #do not append actual file since alrady overwritten
            os.remove("/Users/lucasg17/Downloads/convertcsv (1).xlsx") #deletes file after used
        else:
            add_data(master_book=master_wb, newdata_loc="/Users/lucasg17/Downloads/convertcsv (1).xlsx", name=search_name, file_year=year_2) #put the full amendment first to handle the correct headers
            add_data(master_book=master_wb, newdata_loc="/Users/lucasg17/Downloads/convertcsv.xlsx", name=search_name, file_year=year_1)
